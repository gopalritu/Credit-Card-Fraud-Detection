...
<img src="https://github.com/gopalritu/Credit-Card-Fraud-Detection/blob/main/credit.png" width="400" height="250">
...
```
(https://github.com/gopalritu/Credit-Card-Fraud-Detection.git)
```
